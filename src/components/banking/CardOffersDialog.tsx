...
const bankCards = {
  'SBIN.NS': [
    { name: 'SBI SimplySAVE Credit Card', fee: '499', cashback: '1%', url: 'https://www.sbi.co.in/web/personal-banking/cards/credit-card/simplysave-sbi-card' },
    { name: 'SBI SimplyCLICK Credit Card', fee: '999', cashback: '5% on online spends', url: 'https://www.sbi.co.in/web/personal-banking/cards/credit-card/simplyclick-sbi-card' },
    { name: 'SBI Prime Credit Card', fee: '2,999', cashback: '2% on all spends', url: 'https://www.sbi.co.in/web/personal-banking/cards/credit-card/prime-sbi-card' },
  ],
  'AXISBANK.NS': [
